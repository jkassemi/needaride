...
var page=window.page={url:null,template:null,renderTarget:null,data:null,previewScrollX:null,previewScrollY:null,render:function(e){page.data=e||{};var a=$(document.createElement("div"));$(a).html(page.template(e)),page.renderTarget.replaceWith(a),page.renderTarget=a,$(document).trigger("bowtie:splash-rendered")}};$(function(){var e=$("script#main[type='text/handlebars']");e.length>0&&(page.renderTarget=e,page.template=Handlebars.compile(e.html()),page.data&&page.render(page.data,!1),null!==page.previewScrollX&&null!==page.previewScrollY&&window.scrollTo(page.previewScrollX,page.previewScrollY))}),window.addEventListener("data",function(e){var a=document.documentElement||document.body.parentNode||document.body;page.previewScrollX=void 0!==window.pageXOffset?window.pageXOffset:a.scrollLeft,page.previewScrollY=void 0!==window.pageYOffset?window.pageYOffset:a.scrollTop,page.render(e.detail)});